...
from file_manager import parse_media_information, check_video
...
def process_directory_data(media_directory: str,
    ...
    title_sequence = parse_media_information(directory_name, dir_metadata, dir_info)
...
def process_filenames_data(media_directory: str,
    ...
    for file in filenames:
        ...
        title_sequence = parse_media_information(file, file_metadata, file_info)
